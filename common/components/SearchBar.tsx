...
const shrinkIconOnClick = () => {
    ...
    if(searchIcon){
        ...
        setTimeout(() => {
            if(searchIcon){
                searchIcon.classList.remove('size-6');
    ...
    return (
        <div class="relative flex items-center w-full">
            ...
            <div class="absolute inset-y-0 right-0 flex py-1.5 pr-1.5">
                <button id="searchbutton" class="inline-flex items-center px-1 stroke-white" onclick={() => {
                    onSearch(value);
                    shrinkIconOnClick();
                    
                }}>
                    <div id="iconframe" class="w-10 h-10 flex justify-center items-center">
                        <svg id="searchicon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="size-8">

        ...
        <div>
            <button onclick={toggleTheme} class="cursor-pointer border-black dark:border-white/20">
                <div class="flex items-center justify-center w-10">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="rounded-lg size-6 active:size-5 hidden dark:block fill-white">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="rounded-lg size-6 active:size-5 block dark:hidden fill-black">

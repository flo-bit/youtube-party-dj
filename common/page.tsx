		...
		<main class="w-screen h-screen relative">
			<div class="mx-auto grid md:grid-cols-2 h-screen">
				<div class="h-screen hidden md:flex items-center flex-col justify-center p-8">
					<QRCode code={code} />
					<div id="qrtext2" class="text-white text-3xl font-semibold mt-4">Party code: <span>{code}</span></div>
				</div>
				<div
					id="playerqueuebg"
				...
				>
					...
					<div id="playerqueueborder"
						class="px-4 py-4 border-t border-white/20 mx-0 overflow-y-scroll flex-grow">
